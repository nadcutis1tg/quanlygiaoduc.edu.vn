...
const Students = {
            ...
            <div class="students-page">
                ...
                <div class="filters-section">
                    ...
                    <select id="class-filter" onchange="Students.filterByClass(this.value)">
                        ...
                        <option value="10A1" ${this.filterClass === '10A1' ? 'selected' : ''}>Lớp 10A1</option>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="class" required>
                                    ${Database.classes.map(c => `<option value="${c.name}">${c.name}</option>`).join('')}
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="attendance" min="0" max="100" value="100">
                            </div>
                            <div class="form-group">
                                <label>Tín chỉ</label>
    ...
    saveNewStudent(event) {
        ...
        const studentData = {
            ...
            classId: Database.classes.find(c => c.name === formData.get('class'))?.id,
            ...
            attendance: parseInt(formData.get('attendance')) || 100,
                    ...
                    <form onsubmit="Students.saveEditStudent(event, '${id}')" class="student-form">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label>Lớp <span class="required">*</span></label>
                                <select name="class" required>
                                    ${Database.classes.map(c => `<option value="${c.name}" ${c.name === student.class ? 'selected' : ''}>${c.name}</option>`).join('')}
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Email <span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                <label>Tỷ lệ tham gia (%)</label>
                                <input type="number" name="attendance" min="0" max="100" value="${student.attendance}">
                            </div>
                            <div class="form-group">
                                <label>Tín chỉ</label>
