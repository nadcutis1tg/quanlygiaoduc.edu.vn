...
const AIStudentAnalyzer = {
    ...
    calculateRiskAssessment(student) {
        const factors = {
            ...
            financial: student.financialStatus.hasDebt ? 20 : 0,
            social: student.socialInteractions.isolationScore > 0.5 ? 15 : 0,
            behavioral: student.behaviorNotes.filter(n => n.type === 'negative').length > 3 ? 10 : 0
        };
